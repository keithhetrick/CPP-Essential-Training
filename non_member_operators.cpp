...
/***********************************************
 *
 *  CHAPTER 7 CHALLENGE - NON-MEMBER OPERATORS
 *
 *  Implement the non-member operators for the Rational class so that the following code works.
 *
 *  1.  Implement the non-member operator+ for the Rational class.
 *  2.  Implement the non-member operator- for the Rational class.
 *  3.  Implement the non-member operator* for the Rational class.
 *  4.  Implement the non-member operator/ for the Rational class.
 *
 ************************************************/
